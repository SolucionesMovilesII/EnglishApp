...
describe('UpdateRepetitionUseCase', () => {
  ...
  describe('execute', () => {
    ...
    it('should throw NotFoundException when user does not exist', async () => {
      ...
      // Act & Assert
      await expect(useCase.execute('user-1', 'repetition-1', updateDto))
  ...
  describe('completeRepetition', () => {
    ...
    it('should complete repetition successfully', async () => {
      ...
      // Act
      const result = await useCase.completeRepetition('user-1', 'repetition-1', 92, completeDto.exerciseResults);
    ...
    it('should throw BadRequestException when trying to complete without score', async () => {
      ...
      // Act & Assert
      await expect(useCase.completeRepetition('user-1', 'repetition-1', null as any, {}))
    ...
    it('should throw BadRequestException when repetition is already completed', async () => {
      ...
      // Act & Assert
      await expect(useCase.completeRepetition('user-1', 'repetition-1', 85))
        .rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('abandonRepetition', () => {
    ...
    it('should throw BadRequestException when repetition is already completed', async () => {
      ...
      // Act & Assert
      await expect(useCase.abandonRepetition('user-1', 'repetition-1'))
        .rejects.toThrow(ConflictException);
    });
