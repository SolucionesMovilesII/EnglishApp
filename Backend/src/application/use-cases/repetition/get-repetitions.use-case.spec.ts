...
describe('GetRepetitionsUseCase', () => {
  ...
  describe('execute', () => {
    it('should return user repetitions with pagination', async () => {
      ...
      expect(chapterRepetitionRepository.findByUserId).toHaveBeenCalledWith('user-1', expectedFilters);
    });
    ...
    it('should throw NotFoundException when user does not exist', async () => {
      ...
      // Act & Assert
      await expect(useCase.execute('user-1', options))
  ...
  describe('getRepetitionById', () => {
    ...
    it('should throw NotFoundException when user does not exist', async () => {
      ...
      // Act & Assert
      await expect(useCase.getRepetitionById('user-1', 'repetition-1'))
        .rejects.toThrow(NotFoundException);
    });
  ...
  describe('getRecentRepetitions', () => {
    ...
    it('should throw NotFoundException when user does not exist', async () => {
      ...
      // Act & Assert
      await expect(useCase.getRecentRepetitions('user-1', 5))
        .rejects.toThrow(NotFoundException);
    });
