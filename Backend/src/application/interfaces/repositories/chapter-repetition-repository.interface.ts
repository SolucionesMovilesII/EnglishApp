...
export interface IChapterRepetitionRepository {
  ...
  findByUserAndChapter(userId: string, chapterId: string, filters?: RepetitionFilters): Promise<ChapterRepetition[]>;
  ...
  markAsCompleted(id: string, score: number, exerciseResults?: Record<string, any>): Promise<ChapterRepetition>;
