...
export interface IPracticeSessionRepository {
  ...
  findByUserIdAndType(userId: string, practiceType: PracticeType, limit?: number, offset?: number): Promise<PracticeSession[]>;
  findByUserIdAndChapter(userId: string, chapterId: string, practiceType?: PracticeType): Promise<PracticeSession[]>;
