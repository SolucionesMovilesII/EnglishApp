...
export class QuizAnswerResultDto {
  ...
  @ApiProperty({ description: 'Hint for the question (if incorrect)', example: 'Think about data storage' })
  hint!: string | null;

  @ApiProperty({ description: 'Explanation (optional)', example: 'Variables store data values...' })
  explanation!: string | null;

  @ApiProperty({ description: 'Correct answer text (only if incorrect)', example: 'A container for data' })
