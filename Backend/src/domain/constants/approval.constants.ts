...
export type EvaluationStatus = typeof APPROVAL_CONSTANTS.EVALUATION_STATUS[keyof typeof APPROVAL_CONSTANTS.EVALUATION_STATUS];
export type EvaluationType = typeof APPROVAL_CONSTANTS.EVALUATION_TYPES[keyof typeof APPROVAL_CONSTANTS.EVALUATION_TYPES];
export type RulePriority = typeof APPROVAL_CONSTANTS.RULE_PRIORITIES[keyof typeof APPROVAL_CONSTANTS.RULE_PRIORITIES];
...
export class ApprovalUtils {
  ...
  static isValidScore(score: number): boolean {
    return score >= APPROVAL_CONSTANTS.VALIDATION_LIMITS.MIN_SCORE && 
  ...
  static isValidThreshold(threshold: number): boolean {
    return threshold >= APPROVAL_CONSTANTS.VALIDATION_LIMITS.MIN_THRESHOLD && 
  ...
  static isValidChapterId(chapterId: number): boolean {
    return Number.isInteger(chapterId) &&
  ...
  static isValidAttemptCount(attempts: number): boolean {
    return attempts === APPROVAL_CONSTANTS.UNLIMITED_ATTEMPTS ||
