...
Learning JavaScript opens doors to many career opportunities, including front-end development, back-end development with Node.js, and mobile app development with React Native.`
          ...
          highlightedWords: [
            { word: 'programming language', definition: 'A formal language used to write instructions for computers', page: 1 },
            { word: 'interactive', definition: 'Responding to user actions and input', page: 1 },
            { word: 'browser', definition: 'Software application for accessing websites (Chrome, Firefox, Safari)', page: 1 },
            { word: 'responsive', definition: 'Quick to react and adapt to user input', page: 1 },
            { word: 'versatile', definition: 'Capable of many different functions or uses', page: 1 },
            { word: 'components', definition: 'Parts or elements that make up a larger system', page: 2 },
            { word: 'flexibility', definition: 'The ability to adapt and change easily', page: 2 },
            { word: 'procedural', definition: 'Code organized as a sequence of instructions', page: 2 },
            { word: 'arrow functions', definition: 'A shorter syntax for writing functions in JavaScript (=>)', page: 2 },
            { word: 'efficient', definition: 'Achieving maximum productivity with minimum wasted effort', page: 2 },
            { word: 'script tags', definition: 'HTML tags (<script>) used to embed JavaScript code', page: 3 },
            { word: 'essential', definition: 'Absolutely necessary or extremely important', page: 3 },
            { word: 'interactivity', definition: 'The ability of a program to respond to user actions', page: 3 },
          ],
        },
        quizQuestions: [
          {
          ...
          },
          {
            ...
            explanation: 'JavaScript runs in the browser on the user\'s computer, making websites interactive.',
            order: 2,
          },
          {
            questionText: 'What are the three main components of JavaScript mentioned?',
            options: ['HTML, CSS, JavaScript', 'Variables, functions, objects', 'Front-end, back-end, database', 'Syntax, semantics, logic'],
            correctAnswer: 1,
            hint: 'They are used to store data, perform actions, and organize code',
            explanation: 'The three main components are variables (store data), functions (perform actions), and objects (organize related data).',
            order: 3,
          },
          {
            questionText: 'What do you need to start coding in JavaScript?',
            options: ['A server and database', 'A text editor and browser', 'A mobile phone', 'A special JavaScript computer'],
            correctAnswer: 1,
          ...
          {
            questionText: 'What are the three technologies that form the foundation of web development?',
            options: ['Java, Python, C++', 'HTML, CSS, JavaScript', 'SQL, MongoDB, Redis', 'React, Angular, Vue'],
            correctAnswer: 1,
            hint: 'One provides structure, one adds styling, one brings interactivity',
            explanation: 'HTML (structure), CSS (styling), and JavaScript (interactivity) are the three core web technologies.',
            order: 5,
          },
          {
            questionText: 'What does it mean that JavaScript is "versatile"?',
            options: ['It only runs on Windows', 'It can be used in many different ways', 'It is very difficult to learn', 'It requires expensive software'],
            correctAnswer: 1,
            hint: 'The text mentions it can be written in different styles',
            explanation: 'Versatile means JavaScript is capable of many different functions and can be used in various programming styles.',
            order: 6,
          },
          {
            questionText: 'What is an arrow function?',
            options: ['A function that points up', 'A shorter syntax for writing functions (=>)', 'A function that shoots arrows', 'A deprecated feature'],
            correctAnswer: 1,
            hint: 'It uses the => symbol',
            explanation: 'Arrow functions are a modern JavaScript feature that provides a shorter syntax for writing functions using =>.',
            order: 7,
          },
          {
            questionText: 'What makes websites more responsive and dynamic?',
            options: ['Using more images', 'JavaScript executing in the browser', 'Bigger fonts', 'More colors'],
            correctAnswer: 1,
            hint: 'It runs on the user\'s computer, not on a server',
            explanation: 'JavaScript executes in the browser on the user\'s computer, allowing websites to respond quickly without server requests.',
            order: 8,
          },
          {
            questionText: 'What are script tags used for?',
            options: ['To write CSS code', 'To embed JavaScript code in HTML', 'To create images', 'To format text'],
            correctAnswer: 1,
            hint: 'They are HTML tags that contain JavaScript',
            explanation: 'Script tags (<script>) are used to embed or reference JavaScript code within HTML documents.',
            order: 9,
          },
          {
            questionText: 'According to the text, why is JavaScript essential for web development?',
            options: ['It is the newest language', 'It provides interactivity alongside HTML and CSS', 'It is the easiest to learn', 'It requires no installation'],
            correctAnswer: 1,
            hint: 'Think about what JavaScript adds that HTML and CSS cannot',
            explanation: 'JavaScript is essential because it brings interactivity to websites, complementing HTML\'s structure and CSS\'s styling.',
            order: 10,
          },
        ],
      },
...
The Python community is known for being welcoming and helpful. The **documentation** is comprehensive, and there are countless tutorials, courses, and forums available. This strong community support is one reason why Python continues to grow in popularity.`
          ...
          highlightedWords: [
            { word: 'high-level', definition: 'A programming language closer to human language than machine code', page: 1 },
            { word: 'readable', definition: 'Easy to understand and follow', page: 1 },
            { word: 'indentation', definition: 'Spaces or tabs at the beginning of a line to show code structure', page: 1 },
            { word: 'interpreted', definition: 'Code that is executed line by line without prior compilation', page: 1 },
            { word: 'cross-platform', definition: 'Software that works on multiple operating systems', page: 1 },
            { word: 'programming paradigms', definition: 'Different approaches or styles of programming', page: 2 },
            { word: 'machine learning', definition: 'AI technology that enables computers to learn from data', page: 2 },
            { word: 'ecosystem', definition: 'The collection of tools, libraries, and community around a technology', page: 2 },
            { word: 'pip', definition: 'Python\'s package installer used to install libraries', page: 2 },
            { word: 'critical', definition: 'Extremely important or essential to operations', page: 2 },
            { word: 'automation', definition: 'Making processes run automatically without human intervention', page: 2 },
            { word: 'interpreter', definition: 'A program that executes code directly without compilation', page: 3 },
            { word: 'interactive shell', definition: 'A command-line interface for running Python code immediately', page: 3 },
            { word: 'syntax', definition: 'The rules that define how code must be written', page: 3 },
            { word: 'documentation', definition: 'Written guides and references that explain how to use software', page: 3 },
          ],
        },
        quizQuestions: [
          {
          ...
          },
          {
            ...
            explanation: 'Python uses indentation (spaces or tabs) to define code blocks, unlike languages that use curly braces.',
            order: 2,
          },
          {
            questionText: 'What does it mean that Python is an interpreted language?',
            options: ['It translates languages', 'Code is executed line by line', 'It requires compilation first', 'It only runs on one platform'],
            correctAnswer: 1,
            hint: 'The code runs directly without compilation',
            explanation: 'An interpreted language executes code line by line without needing to be compiled first.',
            order: 3,
          },
          {
            questionText: 'What is pip?',
            options: ['A Python snake', 'Python\'s package installer', 'A programming paradigm', 'A text editor'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: ['The snake', 'Monty Python comedy group', 'A Greek god', 'A computer scientist'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: ['Only object-oriented', 'Procedural, object-oriented, and functional', 'Only functional', 'Only procedural'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: ['It only runs on Windows', 'It runs on multiple operating systems', 'It requires special hardware', 'It needs internet connection'],
            correctAnswer: 1,
            hint: 'It works on Windows, macOS, Linux, etc.',
            explanation: 'Cross-platform means Python runs on multiple operating systems like Windows, macOS, and Linux.',
            order: 8,
          },
          {
...
Learning SQL is essential for anyone working with data. Data **analysts**, software developers, and database **administrators** all need SQL skills. Understanding how to efficiently store and retrieve data is a fundamental skill in modern technology careers.`
          ...
          highlightedWords: [
            { word: 'managing', definition: 'Controlling and organizing resources or information', page: 1 },
            { word: 'manipulating', definition: 'Handling and changing data in various ways', page: 1 },
            ...
            { word: 'tables', definition: 'Data organized in rows and columns like a spreadsheet', page: 1 },
            { word: 'Relational databases', definition: 'Databases that store data in related tables', page: 1 },
            ...
            { word: 'CRUD', definition: 'Create, Read, Update, Delete - basic database operations', page: 2 },
            ...
            { word: 'security', definition: 'Protection against unauthorized access or attacks', page: 2 },
            { word: 'authentication', definition: 'Verifying the identity of a user', page: 2 },
            { word: 'authorization', definition: 'Granting permission to access specific resources', page: 2 },
            { word: 'reliability', definition: 'The ability to perform consistently and dependably', page: 3 },
            { word: 'Normalization', definition: 'Organizing data to reduce redundancy and improve integrity', page: 3 },
            { word: 'performance', definition: 'How efficiently a system operates', page: 3 },
            { word: 'analysts', definition: 'Professionals who examine and interpret data', page: 3 },
            { word: 'administrators', definition: 'People who manage and maintain systems', page: 3 },
          ],
        },
        quizQuestions: [
          {
            questionText: 'What does SQL stand for?',
            options: ['Simple Query Language', 'Structured Query Language', 'Standard Quality Language', 'System Queue Language'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: ['Copy, Read, Upload, Download', 'Create, Read, Update, Delete', 'Connect, Run, Use, Disconnect', 'Code, Rewrite, Upload, Deploy'],
            correctAnswer: 1,
            hint: 'They correspond to INSERT, SELECT, UPDATE, DELETE',
            explanation: 'CRUD stands for Create, Read, Update, and Delete - the four basic database operations.',
            order: 2,
          },
          {
          ...
          },
          {
            ...
            options: ['Deletes tables', 'Combines data from multiple tables', 'Creates new tables', 'Backs up data'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: ['Making data normal', 'Organizing data to reduce redundancy', 'Deleting old data', 'Backing up databases'],
            correctAnswer: 1,
            hint: 'It involves breaking large tables into smaller ones',
            explanation: 'Normalization is organizing data to reduce redundancy by breaking large tables into smaller, related tables.',
            order: 6,
          },
          {
          ...
          },
          {
            ...
            options: ['Random storage', 'The structured approach with relationships', 'Deleting old data', 'Using passwords'],
            correctAnswer: 1,
            hint: 'It is related to how data is organized and related',
            explanation: 'The structured approach with relationships between tables ensures data integrity.',
            order: 8,
          },
          {
            questionText: 'What is authentication in database security?',
            options: ['Deleting users', 'Verifying user identity', 'Creating backups', 'Updating software'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: ['Only database administrators', 'Data analysts, developers, and administrators', 'Only web designers', 'Only managers'],
            correctAnswer: 1,
            hint: 'The text mentions three types of professionals',
            explanation: 'Data analysts, software developers, and database administrators all need SQL skills.',
            order: 10,
          },
        ],
      },
...
Learning Git is crucial for any developer. It enables **effective** collaboration, protects your work, and is required by most employers. Understanding Git concepts like branching, merging, and rebasing will make you a more productive developer.`
          ...
          highlightedWords: [
            { word: 'distributed', definition: 'Spread across multiple locations rather than centralized', page: 1 },
            { word: 'collaborate', definition: 'Work together with others toward a common goal', page: 1 },
            { word: 'history', definition: 'A record of all past changes and versions', page: 1 },
            { word: 'snapshots', definition: 'Saved states of your project at specific points in time', page: 1 },
            { word: 'branching', definition: 'Creating separate lines of development from the main code', page: 1 },
            { word: 'repository', definition: 'A storage location for your project and its version history', page: 1 },
            { word: 'workflow', definition: 'The sequence of steps in a process', page: 2 },
            { word: 'stage', definition: 'Prepare files to be included in the next commit', page: 2 },
            { word: 'commit', definition: 'Save a snapshot of staged changes to the repository', page: 2 },
            ...
            { word: 'resolve', definition: 'Fix conflicts between different versions of code', page: 2 },
            { word: 'pull requests', definition: 'Proposed changes submitted for review before merging', page: 3 },
            { word: 'continuous integration', definition: 'Automatically testing code when changes are made', page: 3 },
        ...
        quizQuestions: [
          { questionText: 'Who created Git?', options: ['Bill Gates', 'Linus Torvalds', 'Mark Zuckerberg', 'Steve Jobs'], correctAnswer: 1, hint: 'He also created Linux', explanation: 'Linus Torvalds created Git in 2005.', order: 1 },
          { questionText: 'What are the three stages in the basic Git workflow?', options: ['Edit, save, upload', 'Working directory, staging area, repository', 'Create, modify, delete', 'Local, remote, cloud'], correctAnswer: 1, hint: 'Changes move through these three areas', explanation: 'The three stages are: working directory, staging area, and repository.', order: 2 },
          { questionText: 'What command stages files for commit?', options: ['git stage', 'git add', 'git save', 'git prepare'], correctAnswer: 1, hint: 'It "adds" files to the staging area', explanation: 'git add stages files for the next commit.', order: 3 },
          { questionText: 'What is a Git branch?', options: ['A tree branch', 'An independent line of development', 'A type of file', 'A command'], correctAnswer: 1, hint: 'It allows parallel development', explanation: 'A branch is an independent line of development in Git.', order: 4 },
          { questionText: 'What should you NEVER commit to a repository?', options: ['Code files', 'Sensitive information like passwords', 'Documentation', 'Configuration files'], correctAnswer: 1, hint: 'Things like API keys and passwords', explanation: 'Never commit sensitive information like passwords or API keys.', order: 5 },
          { questionText: 'What is merging?', options: ['Deleting branches', 'Combining changes from different branches', 'Creating new files', 'Uploading to cloud'], correctAnswer: 1, hint: 'It brings together changes from different branches', explanation: 'Merging combines changes from different branches.', order: 6 },
          { questionText: 'What command creates a new Git repository?', options: ['git create', 'git new', 'git init', 'git start'], correctAnswer: 2, hint: 'It "initializes" a repository', explanation: 'git init creates a new Git repository.', order: 7 },
          { questionText: 'What is a pull request used for?', options: ['Downloading files', 'Submitting code changes for review', 'Deleting branches', 'Creating backups'], correctAnswer: 1, hint: 'Team members review it before merging', explanation: 'Pull requests allow code review before merging changes.', order: 8 },
          { questionText: 'What makes Git "distributed"?', options: ['It uses the internet', 'Every developer has a full copy of the repository', 'It is free', 'It works on all platforms'], correctAnswer: 1, hint: 'Everyone has the complete history', explanation: 'Git is distributed because every developer has a full copy of the repository.', order: 9 },
          { questionText: 'Name one platform for hosting Git repositories mentioned in the text', options: ['Facebook', 'GitHub', 'Instagram', 'Twitter'], correctAnswer: 1, hint: 'It is specifically for code hosting', explanation: 'GitHub is a popular platform for hosting Git repositories.', order: 10 },
        ],
      },
...
Understanding REST principles helps you design clean, maintainable APIs. Whether building **microservices** or integrating third-party services, REST knowledge is fundamental for modern developers.`
          ...
          highlightedWords: [
            { word: 'networked', definition: 'Connected systems that communicate over a network', page: 1 },
            ...
            { word: 'stateless', definition: 'Not storing information about previous requests', page: 1 },
            { word: 'context', definition: 'Information about the current state or situation', page: 1 },
            ...
            { word: 'status codes', definition: 'Numbers indicating the result of HTTP requests', page: 2 },
            { word: 'Authentication', definition: 'Verifying the identity of a user or system', page: 2 },
            { word: 'authorized', definition: 'Having permission to access resources', page: 2 },
            { word: 'documentation', definition: 'Written instructions and information about using software', page: 3 },
            { word: 'Rate limiting', definition: 'Restricting the number of requests a client can make', page: 3 },
            { word: 'Versioning', definition: 'Managing different versions of an API', page: 3 },
            { word: 'microservices', definition: 'Small, independent services that work together', page: 3 },
          ],
        },
        quizQuestions: [
          { questionText: 'What does REST stand for?', options: ['Remote State Transfer', 'Representational State Transfer', 'Rapid Service Technology', 'Resource System Transfer'], correctAnswer: 1, hint: 'The first word is "Representational"', explanation: 'REST stands for Representational State Transfer.', order: 1 },
          { questionText: 'Which HTTP method is used to retrieve data?', options: ['POST', 'DELETE', 'GET', 'PUT'], correctAnswer: 2, hint: 'You "get" data', explanation: 'GET is used to retrieve data from an API.', order: 2 },
          { questionText: 'What format do REST APIs typically return data in?', options: ['XML', 'JSON', 'CSV', 'PDF'], correctAnswer: 1, hint: 'It is easy for both humans and machines to read', explanation: 'REST APIs typically return data in JSON format.', order: 3 },
          { questionText: 'What does "stateless" mean in REST?', options: ['APIs have no status', 'Each request contains all needed information', 'APIs never fail', 'No authentication required'], correctAnswer: 1, hint: 'The server does not store client context', explanation: 'Stateless means each request contains all information needed to process it.', order: 4 },
          { questionText: 'What HTTP status code indicates success?', options: ['404', '500', '200', '301'], correctAnswer: 2, hint: 'It is a 2xx code', explanation: '200 is the HTTP status code for a successful request.', order: 5 },
          { questionText: 'What is an API endpoint?', options: ['The end of an API', 'A URL that provides access to resources', 'A type of database', 'A security feature'], correctAnswer: 1, hint: 'It is a URL path', explanation: 'An endpoint is a URL that provides access to specific API resources.', order: 6 },
          { questionText: 'Why is API documentation important?', options: ['It is required by law', 'It helps developers understand how to use the API', 'It makes APIs faster', 'It adds security'], correctAnswer: 1, hint: 'It explains how to use the API', explanation: 'Documentation helps developers understand endpoints, parameters, and responses.', order: 7 },
          { questionText: 'What is rate limiting?', options: ['Making APIs faster', 'Restricting the number of requests', 'Charging for API use', 'Deleting old data'], correctAnswer: 1, hint: 'It prevents abuse', explanation: 'Rate limiting restricts how many requests a client can make to prevent abuse.', order: 8 },
          { questionText: 'What authentication method uses tokens?', options: ['Basic Auth', 'JWT', 'Cookies', 'Sessions'], correctAnswer: 1, hint: 'It stands for JSON Web Token', explanation: 'JWT (JSON Web Token) is a token-based authentication method.', order: 9 },
          { questionText: 'What allows different API versions to coexist?', options: ['Versioning', 'Authentication', 'Rate limiting', 'Documentation'], correctAnswer: 0, hint: 'It uses paths like /v1/ and /v2/', explanation: 'Versioning allows different API versions (like v1 and v2) to coexist.', order: 10 },
        ],
      },
      ...
      // Chapters 6-10 abbreviated for space (full version would have complete content)
      {
        ...
        content: { title: 'Docker Basics', estimatedReadingTime: 6, topic: 'DevOps', pages: ['Docker is a **platform** for developing, shipping, and running applications in containers...', 'Containers package application code with all **dependencies**...', 'Docker **images** are templates used to create containers...'] },
        highlightedWords: [
          { word: 'platform', definition: 'A system that provides a foundation for applications', page: 1 },
          { word: 'dependencies', definition: 'External libraries or tools that software needs to run', page: 2 },
          { word: 'images', definition: 'Templates containing all files needed to run a container', page: 3 },
        ],
...

      {
        ...
        content: { title: 'AWS Fundamentals', estimatedReadingTime: 7, topic: 'Cloud Computing', pages: ['Amazon Web Services (AWS) is a **comprehensive** cloud platform...', 'AWS offers **compute** power, storage, and databases...', 'Common AWS services include EC2, S3, and **Lambda**...'] },
        highlightedWords: [
          ...
          { word: 'Lambda', definition: 'AWS service for running code without managing servers', page: 3 },
        ],
        quizQuestions: Array.from({length: 10}, (_, i) => ({
...

      {
        ...
        content: { title: 'Microservices Principles', estimatedReadingTime: 7, topic: 'Software Architecture', pages: ['Microservices architecture breaks applications into small, **independent** services...', 'Each microservice handles a specific **domain** or business function...', 'Communication between services uses APIs and **message queues**...'] },
        highlightedWords: [
          { word: 'independent', definition: 'Self-contained and not relying on other components', page: 1 },
          { word: 'domain', definition: 'A specific area of business logic or functionality', page: 2 },
          { word: 'message queues', definition: 'Systems for asynchronous communication between services', page: 3 },
        ],
        quizQuestions: Array.from({length: 10}, (_, i) => ({
...

      {
        ...
        content: { title: 'ML Fundamentals', estimatedReadingTime: 7, topic: 'Artificial Intelligence', pages: ['Machine Learning enables computers to learn from **data** without explicit programming...', '**Supervised** learning uses labeled data to train models...', 'Common ML **algorithms** include decision trees and neural networks...'] },
        highlightedWords: [
          { word: 'data', definition: 'Information used to train machine learning models', page: 1 },
          { word: 'Supervised', definition: 'Learning with labeled training data', page: 2 },
          { word: 'algorithms', definition: 'Step-by-step procedures for calculations and problem-solving', page: 3 },
        ],
        quizQuestions: Array.from({length: 10}, (_, i) => ({
...

      {
        ...
        content: { title: 'Security Fundamentals', estimatedReadingTime: 7, topic: 'Security', pages: ['Cybersecurity protects systems and data from **threats** and attacks...', 'Common threats include **malware**, phishing, and SQL injection...', '**Encryption** converts data into unreadable format for protection...'] },
        highlightedWords: [
          ...
          { word: 'Encryption', definition: 'Converting data into a coded format to prevent unauthorized access', page: 3 },
        ],
        quizQuestions: Array.from({length: 10}, (_, i) => ({
