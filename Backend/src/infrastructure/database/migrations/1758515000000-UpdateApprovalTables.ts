...
export class UpdateApprovalTables1758515000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "approval_rules" DROP COLUMN IF EXISTS "instructorId"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_rules" DROP COLUMN IF EXISTS "groupId"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_rules" DROP COLUMN IF EXISTS "ruleName"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_rules" DROP COLUMN IF EXISTS "criteria"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_rules" DROP COLUMN IF EXISTS "weights"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_rules" DROP COLUMN IF EXISTS "thresholds"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "approval_evaluations" DROP COLUMN IF EXISTS "sessionId"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_evaluations" DROP COLUMN IF EXISTS "metrics"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_evaluations" DROP COLUMN IF EXISTS "calculatedScore"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_evaluations" DROP COLUMN IF EXISTS "approved"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "approval_metrics" DROP COLUMN IF EXISTS "accuracy"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_metrics" DROP COLUMN IF EXISTS "responseTime"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_metrics" DROP COLUMN IF EXISTS "consistency"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_metrics" DROP COLUMN IF EXISTS "vocabularyMastery"`
    );
    await queryRunner.query(
      `ALTER TABLE "approval_metrics" DROP COLUMN IF EXISTS "grammarScore"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "approval_metrics" DROP COLUMN IF EXISTS "evaluationId"`
    );
