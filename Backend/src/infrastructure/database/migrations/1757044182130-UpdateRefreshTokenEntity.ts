...
export class UpdateRefreshTokenEntity1757044182130 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "token_hash" character varying(500) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "UQ_f3752400c98d5c0b3dca54d66d5" UNIQUE ("jti")`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "replaced_by" uuid`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "revoked_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "reason" character varying(64)`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "device_info" character varying(255)`);
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "UQ_f3752400c98d5c0b3dca54d66d5"`);
