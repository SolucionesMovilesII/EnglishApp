...
export class CreateChaptersAndVocabularyTables1757601116368 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_fff2d62c07af5fb02b64970e09" ON "chapters" ("level", "order") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d4b7dead298f04c4761b8f94d9" ON "chapters" ("order") `);
        await queryRunner.query(`ALTER TABLE "user_progress" ADD "chapterCompleted" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "user_progress" ADD "chapterCompletionDate" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "user_progress" ADD "vocabularyItemsLearned" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "user_progress" ADD "totalVocabularyItems" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`CREATE INDEX "IDX_d8f5dc5e9521a8b1e2bc1e7057" ON "user_progress" ("chapterCompleted") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4f93fb77effff1b1afa22b7ada" ON "user_progress" ("userId", "chapterId") `);
        await queryRunner.query(`CREATE INDEX "IDX_219170359a4b47df749c5f8735" ON "user_progress" ("chapterId") `);
        await queryRunner.query(`ALTER TABLE "vocabulary_items" ADD CONSTRAINT "FK_c688154f9fcd00b297edcfdb889" FOREIGN KEY ("chapterId") REFERENCES "chapters"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_progress" ADD CONSTRAINT "FK_219170359a4b47df749c5f87358" FOREIGN KEY ("chapterId") REFERENCES "chapters"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_progress" DROP CONSTRAINT "FK_219170359a4b47df749c5f87358"`);
        await queryRunner.query(`ALTER TABLE "vocabulary_items" DROP CONSTRAINT "FK_c688154f9fcd00b297edcfdb889"`);
