...
export class ProgressController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new progress record or updates an existing one for the authenticated user',
  })
  @ApiResponse({ status: 201, description: 'Progress created or updated successfully', type: ProgressResponseDto })
  ...
  @ApiParam({ name: 'userId', description: 'User ID to get progress for', type: 'string', format: 'uuid' })
  @ApiResponse({ status: 200, description: 'User progress retrieved successfully', type: UserProgressListDto })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  ...
  @ApiResponse({ status: 200, description: 'Progress updated successfully', type: ProgressResponseDto })
  @ApiResponse({ status: 400, description: 'Invalid input data' })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  ...
  @ApiResponse({ status: 201, description: 'Repetition started successfully', type: RepetitionResponseDto })
  ...
  async startRepetition(
    ...
    try {
      ...
      this.logger.error(`Error starting repetition: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @ApiResponse({ status: 200, description: 'Repetitions retrieved successfully', type: [RepetitionResponseDto] })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  @ApiResponse({ status: 404, description: 'User not found' })
  async getUserRepetitions(@Request() req: AuthenticatedRequest): Promise<RepetitionResponseDto[]> {
    ...
    try {
      ...
      this.logger.error(`Error getting repetitions: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @ApiResponse({ status: 200, description: 'Recent repetitions retrieved successfully', type: [RepetitionResponseDto] })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  @ApiResponse({ status: 404, description: 'User not found' })
  async getRecentRepetitions(@Request() req: AuthenticatedRequest): Promise<RepetitionResponseDto[]> {
    ...
    try {
      ...
      this.logger.error(`Error getting recent repetitions: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @ApiResponse({ status: 200, description: 'Repetition statistics retrieved successfully', type: RepetitionStatsDto })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  @ApiResponse({ status: 404, description: 'User not found' })
  async getRepetitionStats(@Request() req: AuthenticatedRequest): Promise<RepetitionStatsDto> {
    ...
    try {
      ...
      this.logger.error(`Error getting repetition stats: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @ApiResponse({ status: 200, description: 'Repetition retrieved successfully', type: RepetitionResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  ...
  async getRepetitionById(
    ...
    try {
      ...
      this.logger.error(`Error getting repetition: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @HttpCode(HttpStatus.OK)
  @UsePipes(new ValidationPipe({ whitelist: true, forbidNonWhitelisted: true }))
  @ApiOperation({ summary: 'Update repetition', description: 'Updates an existing repetition session' })
  @ApiParam({ name: 'id', description: 'Repetition ID', type: 'string', format: 'uuid' })
  @ApiResponse({ status: 200, description: 'Repetition updated successfully', type: RepetitionResponseDto })
  @ApiResponse({ status: 400, description: 'Invalid input data' })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  @ApiResponse({ status: 404, description: 'Repetition not found' })
  ...
  async updateRepetition(
    ...
    try {
      return await this.updateRepetitionUseCase.execute(req.user.userId, repetitionId, updateRepetitionDto);
    } catch (error) {
      this.logger.error(`Error updating repetition: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @HttpCode(HttpStatus.OK)
  @UsePipes(new ValidationPipe({ whitelist: true, forbidNonWhitelisted: true }))
  @ApiOperation({ summary: 'Complete repetition', description: 'Marks a repetition as completed with final score' })
  @ApiParam({ name: 'id', description: 'Repetition ID', type: 'string', format: 'uuid' })
  @ApiResponse({ status: 200, description: 'Repetition completed successfully', type: RepetitionResponseDto })
  ...
  async completeRepetition(
    ...
    try {
      ...
      this.logger.error(`Error completing repetition: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  @ApiParam({ name: 'id', description: 'Repetition ID', type: 'string', format: 'uuid' })
  @ApiResponse({ status: 200, description: 'Repetition abandoned successfully', type: RepetitionResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
  @ApiResponse({ status: 404, description: 'Repetition not found' })
  @ApiResponse({ status: 409, description: 'Repetition is not active' })
  async abandonRepetition(
    ...
    try {
      ...
      this.logger.error(`Error abandoning repetition: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
}
